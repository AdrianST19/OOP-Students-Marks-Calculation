...
namespace DLLFile
{
    public class StudentLicenta : Persoana
    {
        private static int nota1, nota2, nota3, nota4, nota5, nota6;
        private int total;
        private double media;
        private int[] note = new int[6];
        public readonly int numarMaterii = 6; //readonly
        private string status;
        NivelulStudiilor studii; // includere de clasa, continuarea se afla mai jos

        public StudentLicenta(string nume, int nota1, int nota2, int nota3, int nota4, int nota5, int nota6) : base(nume)
        {
            this.note[0] = nota1;
            this.note[1] = nota2;
            this.note[2] = nota3;
            ...
            this.note[4] = nota5;
            this.note[5] = nota6;
            this.total = nota1 + nota2 + nota3 + nota4 + nota5 + nota6;
            this.media = total / 6;
        }

        public StudentLicenta(string nume, double media) : base(nume)
        {
        ...
        public string AfisareStatus()
        {
            ...
            status = (promovare == true && this.media >= 5) ? "Promovat Licenta" : "Nepromovat Licenta";
            return status;
        }
        ...
        public string NivelStudii() // polimorfism
        {
            ...
            studii.NivelStudii = "Universitare de licenta"; //setter nivel de studii
